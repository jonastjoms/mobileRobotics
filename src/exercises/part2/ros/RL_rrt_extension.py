...
def get_velocity(error, old_error, p_value, d_value):
    # Get error derivative:
    d_error = error - old_error
    # Calculate velocity
    v = p_value*error + d_value*d_error
    return v
        ...
        try:
            ...
            if (goal_reached or step % 200 == 0):
                ...
                if not testing:
                    ...
                    d_values[key] = sum_d_value/episode_step
                    episode_reward = 0
                    episode_error = 0
                    episode_step = 0
                    sum_p_value = 0
            ...
            old_error = error
            error = subgoal.position-position

            episode_reward += reward
            episode_error += np.linalg.norm(error)
            episode_step += 1
            sum_p_value += p_value
            sum_d_value += d_value
            ...
            if step % SAVE_INTERVAL == 0:
                ...
                pickle.dump( rewards, open( "/home/jonas/catkin_ws/src/exercises/part2/ros/checkpoints/training_rewards_extension.p", "wb" ) )
                pickle.dump( errors, open( "/home/jonas/catkin_ws/src/exercises/part2/ros/checkpoints/errors_extension.p", "wb" ) )
                pickle.dump( p_values, open( "/home/jonas/catkin_ws/src/exercises/part2/ros/checkpoints/p_values.p", "wb" ) )
                pickle.dump( d_values, open( "/home/jonas/catkin_ws/src/exercises/part2/ros/checkpoints/d_values.p", "wb" ) )
